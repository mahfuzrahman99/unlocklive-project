...
const Perfection = () => {
  return (
    <div className="md:flex gap-5 justify-between items-center PTop">
      <div className="space-y-3">
        <div className="flex items-center gap-1 text-[#86371C]">
          ...
          <p className=" text-xs font-lemonada">Why Choose Us</p>
        </div>
        <p className="text-xl md:text-3xl font-bold font-bakilda">
        ...
        <div>
          <button className="text-xs border text-[#86371C] font-semibold border-[#86371C] p-2 rounded-md  font-valueSanse">
            Explore Our Menus
          </button>
        </div>
      </div>
